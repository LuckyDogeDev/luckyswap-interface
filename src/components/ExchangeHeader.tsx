    ...
    return (
        <div className="flex justify-between space-x-3 pt-4 px-4">
            <div className="grid grid-cols-2 rounded-md p-3px md:bg-dark-800">
                <NavLink
                    className="flex items-center justify-center px-4 rounded-lg md:px-10 text-center text-secondary hover:text-high-emphesis text-base font-medium"
                    activeClassName="font-bold bg-transparent border-4 rounded text-high-emphesis border-transparent md:border-gradient-r-blue-pink-dark-800"
                    to={{
                        pathname: '/swap',
