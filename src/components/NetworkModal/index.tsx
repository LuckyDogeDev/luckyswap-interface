    ...
    return (
        <Modal isOpen={networkModalOpen} onDismiss={toggleNetworkModal}>
            ...
            <div className="text-lg text-primary mb-6">
                You are currently browsing <span className="font-bold text-pink">LuckyFinance</span>
                ...
                {[
                    ...
                    if (chainId === key) {
                        return (
                            <button key={i} className="bg-gradient-to-r from-blue to-pink w-full rounded p-px">
                                <div className="flex items-center h-full w-full bg-dark-700 rounded p-3">
                                    <img
                    ...
                    return (
                        <button
                            ...
                            className="flex items-center bg-dark-700 hover:bg-dark-1000 w-full rounded p-3 cursor-pointer"
                        >
