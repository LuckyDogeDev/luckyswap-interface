...
import { JSBI, Pair, Percent, TokenAmount } from '@luckyfinance/sdk'
    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex-1 mr-2 py-2 rounded-lg text-xs md:text-sm md:text-bold text-primary">
                ...
                <div className="flex flex-col md:flex-row justify-between flex-1 text-xs md:text-sm px-3 py-2 text-primary rounded-lg md:text-bold bg-dark-900">
                    <div>
                        <span className="text-primary">{token0Deposited ? token0Deposited?.toSignificant(6) : '-'}</span>
                        <span className="ml-1">{currency0.getSymbol(chainId)}</span>
                    </div>
                    <div>
                        <span className="text-primary">{token1Deposited ? token1Deposited?.toSignificant(6) : '-'}</span>
