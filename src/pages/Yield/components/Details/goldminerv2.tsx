...
import { Token, WETH } from '@luckyfinance/sdk'
...
import useGoldMinerV2 from '../../hooks/goldminerv2/useGoldMinerV2'
import usePendingReward from '../../hooks/goldminerv2/usePendingReward'
import usePendingGoldNugget from '../../hooks/goldminerv2/usePendingGoldNugget'
import useStakedBalance from '../../hooks/goldminerv2/useStakedBalance'
...
export default function InputGroup({
    ...
    const [approvalState, approve] = useApproveCallback(
        ...
        '0xEF0881eC094552b2e128Cf945EF17a6752B4Ec5d' //goldminerv2 on mainnet
    )
    //console.log('Approval:', approvalState, ApprovalState.NOT_APPROVED)

    const { deposit, withdraw, harvest } = useGoldMinerV2()
            ...
            <div className="flex flex-col py-6 space-y-4">
                {pending && Number(pending) > 0 && (
                    <div className="px-4 ">
                        ...
                        >
                            Harvest {formattedNum(pending)} GOLN & {formattedNum(reward)} ALCX
                        </Button>
                    </div>
                )}
                <div className="px-4">
                ...
                <div className="grid grid-cols-1 gap-4 px-4 sm:grid-cols-2">
                    ...
                    {type === 'KMP' && assetSymbol && (
                        <>
                            <Button
                                color="default"
                                onClick={() => history.push(`/alp/goldvein/lend/${isWETH(pairAddress)}`)}
                            >
