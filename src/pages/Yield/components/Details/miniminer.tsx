...
import useMiniMinerV2 from '../../hooks/miniminer/useMiniMinerV2'
import usePendingGoldNugget from '../../hooks/miniminer/usePendingGoldNugget'
import usePendingReward from '../../hooks/miniminer/usePendingReward'
import useStakedBalance from '../../hooks/miniminer/useStakedBalance'
...
export default function InputGroup({
    ...
    const [approvalState, approve] = useApproveCallback(
        ...
        '0x0769fd68dFb93167989C6f7254cd0D766Fb2841F' //miniMiner on Matic
    )
    //console.log('Approval:', approvalState, ApprovalState.NOT_APPROVED)

    const { deposit, withdraw, harvest } = useMiniMinerV2()
            ...
            <div className="flex flex-col space-y-4 py-6">
                {pending && Number(pending) > 0 && (
                    <div className=" px-4">
                        ...
                        >
                            <Trans>
                                Harvest {formattedNum(pending)} GOLN & {formattedNum(reward)} MATIC
                            </Trans>
                        </Button>
                    </div>
                )}
