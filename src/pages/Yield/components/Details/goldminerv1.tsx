...
import useGoldMiner from '../../hooks/goldminerv1/useGoldMiner'
import usePendingGoldNugget from '../../hooks/goldminerv1/usePendingGoldNugget'
import useStakedBalance from '../../hooks/goldminerv1/useStakedBalance'
import useTokenBalance from '../../hooks/goldminerv1/useTokenBalance'
...
export default function InputGroup({
    ...
    const { deposit, withdraw, harvest } = useGoldMiner()
            ...
            <div className="flex flex-col space-y-4 py-6">
                ...
                {pending && Number(pending) > 0 && (
                    <div className=" px-4">
                        ...
                        >
                            {i18n._(t`Harvest ${formattedNum(pending)} GOLN`)}
                        </Button>
                    </div>
                )}
            </div>
