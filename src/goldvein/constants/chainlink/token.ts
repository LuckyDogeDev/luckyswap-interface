...
export const CHAINLINK_TOKENS: { [chainId in ChainId]?: ChainlinkToken[] } = {
    [ChainId.MAINNET]: [
        ...
        { symbol: 'GOLN', name: 'GoldNugget', address: '0xd0fb6753E4A2dFfA6033836327e23Ec2e417446E', decimals: 18 },
        ...
        { symbol: 'PLAN', name: 'AlchemyBench', address: '0x210e8B3600aea3943D2e45a913723931c97895Fe', decimals: 18 },
