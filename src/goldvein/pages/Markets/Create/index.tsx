...
import DepositGraphic from 'assets/goldvein/deposit-graphic.png'
import { Helmet } from 'react-helmet'
import OracleListBox from './OracleListBox'
import TokenListBox from './TokenListBox'
import { e10 } from 'goldvein/functions/math'
...
const CreatePair = () => {
    ...
    const handleCreate = async () => {
        try {
            ...
            const goldveinData = ethers.utils.defaultAbiCoder.encode(
    ...
    return (
        ...
        >
            <Helmet>
                <title>Create Market | LuckyFinance</title>
            </Helmet>
            <Card
                className="h-full bg-dark-900"
                header={
            ...
            >
                <div className="space-y-6">
                    <p>
                        Currently only Chainlink oracles are available. Support for more oracles, such as LuckySwap
